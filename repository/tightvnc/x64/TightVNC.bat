...
::                1.0.1 + Add commands to stop and restart TightVNC server service after installation. Thanks to /u/BadMoodinTheMorning
::                1.0.0 + Initial write
...
set LOGFILE=%COMPUTERNAME%_TightVNC_x64_install.log

:: Package to install. Do not use trailing slashes (\)
set BINARY=TightVNC v2.8.27 x64.msi
