...
set LOGFILE=jre6_i586_update.log

:: Package to install. Do not use trailing slashes (\)
set LOCATION=
set BINARY=jre-6u115-windows-i586.exe
...
:: INSTALLATION ::
::::::::::::::::::
:: Install the package from a network location
...
:: Delete a bunch of pointless shortcuts Java creates in the Start Menu (sigh...)
