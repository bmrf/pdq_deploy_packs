...
set LOGFILE=jre9_x64_update.log

:: Package to install. Do not use trailing slashes (\)
set LOCATION=
set BINARY=jre-9_windows-x64_bin.msi
...
echo %CUR_DATE% %TIME%   Uninstalling all versions of JRE 9 x64 prior to installation of current version...>> "%LOGPATH%\%LOGFILE%"
...
:: Second version of the command to catch JRE8 versions above 99 where they start using 3-digit identifiers instead of 2-digit
