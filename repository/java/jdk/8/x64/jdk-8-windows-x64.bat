...
set LOGFILE=jdk8_x64_install.log

:: Package to install. Do not use trailing slashes (\)
set BINARY=jdk-8u231-windows-x64.exe
...
wmic product where "IdentifyingNumber like '{64A3A4F4-B792-11D6-A78A-00B0D0180__0}'" call uninstall /nointeractive>> "%LOGPATH%\%LOGFILE%" 2>NUL
