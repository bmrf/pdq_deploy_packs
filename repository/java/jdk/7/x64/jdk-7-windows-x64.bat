...
set LOGFILE=jdk7_x64_update.log

:: Package to install. Do not use trailing slashes (\)
set LOCATION=
set BINARY=jdk-7u80-windows-x64.exe
set FLAGS=/s /l %LOGPATH%\%LOGFILE%
...
:: INSTALLATION ::
::::::::::::::::::
:: Remove previous versions of the JDK, series 7. The first two digits are the architecture (32 or 64) and the two underscores are WMI wildcards for single characters.
...
:: catch anything else.
wmic product where "IdentifyingNumber like '{64A3A4F4-B792-11D6-A78A-00B0D0170__0}'" call uninstall /nointeractive>> "%LOGPATH%\%LOGFILE%" 2>NUL
...
::wmic product where "name like 'Java SE Development Kit 7 Update%%(64-bit)'" uninstall /nointeractive>> "%LOGPATH%\%LOGFILE%" 2>NUL
