...
set LOGFILE=jdk7_i586_update.log

:: Package to install. Do not use trailing slashes (\)
set LOCATION=
set BINARY=jdk-7u80-windows-i586.exe
...
:: catch anything else.
wmic product where "IdentifyingNumber like '{32A3A4F4-B792-11D6-A78A-00B0D0170__0}'" call uninstall /nointeractive>> "%LOGPATH%\%LOGFILE%" 2>NUL
...
::wmic product where "name like 'Java SE Development Kit 7 Update%%'" uninstall /nointeractive>> "%LOGPATH%\%LOGFILE%" 2>NUL
