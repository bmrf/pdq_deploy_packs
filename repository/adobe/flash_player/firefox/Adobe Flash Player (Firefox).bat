...
set BINARY=install_flash_player_32_plugin.msi
...
echo %CUR_DATE% %TIME% Killing any running Mozilla-based browsers first, please wait...
echo %CUR_DATE% %TIME% Killing any running Mozilla-based browsers first, please wait...>> "%LOGPATH%\%LOGFILE%" 2>NUL
