...
set LOGFILE=%COMPUTERNAME%_Palemoon_x64_install.log

:: Package to install. Do not use trailing slashes (\)
set BINARY=Palemoon.exe
set FLAGS=-ms
...
::::::::::::::::::
:: Kill Pale Moon
echo %CUR_DATE% %TIME% Killing any running Palemoon instsances, please wait...
echo %CUR_DATE% %TIME% Killing any running Palemoon instsances, please wait...>> "%LOGPATH%\%LOGFILE%" 2>NUL
